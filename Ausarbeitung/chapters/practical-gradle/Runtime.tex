...
\begin{figure}[hbt!]
	\lstinputlisting[language=groovy] {code/CallInterceptor.groovy}
...
\begin{figure}[hbt!]
	\lstinputlisting[language=groovy, linerange={43-64}, firstnumber=43]{code/MetaTester.groovy}
...
\begin{figure}[hbt!]
	\lstinputlisting[language=groovy, linerange={108-116}, firstnumber=108]{code/MetaTester.groovy}
...
\begin{figure}[hbt!]
	\lstinputlisting[language=groovy, linerange={25-30}, firstnumber=25]{code/MetaTester.groovy}
...
\begin{figure}[t!]
	\begin{subfigure}{\textwidth}
		\lstinputlisting[, linerange={2-14}, firstnumber=2]{terminal/testresults/case11.txt}
		\caption{Groovy Ausgabe}
		\label{fig:proxres-direct-groovy}
	\end{subfigure}

	\begin{subfigure}{\textwidth}
		\lstinputlisting[, linerange={2-22}, firstnumber=2]{terminal/testresults/case12.txt}
...
\begin{figure}[t!]
	\begin{subfigure}{\textwidth}
		\lstinputlisting[linerange={2-16}, firstnumber=2]{terminal/testresults/prox-indir-groovy.txt}
		\caption{Groovy Ausgabe}
		\label{fig:proxres-indirect-groovy}
	\end{subfigure}
	
	\begin{subfigure}{\textwidth}
		\lstinputlisting[linerange={2-7}, firstnumber=2]{terminal/testresults/prox-indir-java.txt}
		\caption{Java Ausgabe}
...
\begin{figure}[hbt!]
	\lstinputlisting[language=groovy, linerange={66-82}, firstnumber=66]{code/MetaTester.groovy}
...
\begin{figure}[hbt!]
	\lstinputlisting[language=groovy, linerange={84-106}, firstnumber=66]{code/MetaTester.groovy}
...
\begin{figure}[hbt!]
	\begin{subfigure}{\textwidth}
		\lstinputlisting[linerange={9-23}, firstnumber=9]{terminal/testresults/case41.txt}
		\caption{Groovy Ausgabe}
	\end{subfigure}
	
	\begin{subfigure}{\textwidth}
		\lstinputlisting[linerange={9-27}, firstnumber=9]{terminal/testresults/case42.txt}
		\caption{Java Ausgabe}
	\end{subfigure}
...
\begin{figure}[hbt!]
	\begin{subfigure}{\textwidth}
		\lstinputlisting[firstline=9, firstnumber=9]{terminal/testresults/case51.txt}
		\caption{Groovy Ausgabe}
	\end{subfigure}
	
	\begin{subfigure}{\textwidth}
		\lstinputlisting[firstline=9, firstnumber=9]{terminal/testresults/case52.txt}
		\caption{Java Ausgabe}
	\end{subfigure}
